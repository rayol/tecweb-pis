...
public class BuildPersonalizedPageRankRecords extends Configured implements Tool {
        ...
        public void map(LongWritable key, Text t, Context context) throws IOException,
            ...
            for(int i = 0; i < personalizedSources.length; i++) {
                ...
                if(Integer.parseInt(personalizedSources[i]) == nid.get()) {
                    pageRank.add((float) StrictMath.log(1.0f));
                } else {
                    pageRank.add((float) StrictMath.log(0.0f));
                }
                //LOG.info("PageRank :       " + pageRank.toString() + "                Node :                 " + nid.get());
            }
    ...
    public int run(String[] args) throws Exception {
        ...
        LOG.info(" - numNodes: " + n);
        LOG.info(" - personalizedSources: " + personalizedSources);
